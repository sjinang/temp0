...
#report_timing -path full -delay min -max paths 20
redirect "reports/timing_report_maxsm" { report_timing -path full -delay min -max_paths 50 -significant_digits 4 }
